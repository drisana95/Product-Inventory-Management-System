...
def add_product():
    ...
    save_btn = tk.Button(add_window, text="Save", command=save_product, width=20, height=2, bg="#87CEEB", fg="black")
...
def edit_product():
    ...
    save_btn = tk.Button(edit_window, text="Save Changes", command=save_changes, width=20, height=2, bg="#87CEEB", fg="black")
...
def delete_product():
    ...
    delete_btn = tk.Button(delete_window, text="Delete Product", command=confirm_delete, width=20, height=2, bg="#87CEEB", fg="black")
...
def purchase_product():
    ...
    save_btn = tk.Button(purchase_window, text="Purchase", command=save_purchase, width=20, height=2, bg="#87CEEB", fg="black")
...
def sell_item():
    ...
    save_btn = tk.Button(sell_window, text="Sell", command=save_sale, width=20, height=2, bg="#87CEEB", fg="black")
    save_btn.grid(row=2, columnspan=2, padx=10, pady=10)
...
root.configure(bg="#FF69B4")  # Pink Background Color

# Welcome message
welcome_label = tk.Label(root, text="Welcome to Fashion Management", font=("Helvetica", 16, "bold"), bg="#FF69B4", fg="white")
welcome_label.pack(pady=20)  # Increased padding

# Add buttons for various operations
add_btn = tk.Button(root, text="Add Product", command=add_product, width=20, height=2, bg="#87CEEB", fg="black")
add_btn.pack(pady=5)
view_btn = tk.Button(root, text="View Product", command=view_product, width=20, height=2, bg="#87CEEB", fg="black")
view_btn.pack(pady=5)
edit_btn = tk.Button(root, text="Edit Product", command=edit_product, width=20, height=2, bg="#87CEEB", fg="black")
edit_btn.pack(pady=5)
delete_btn = tk.Button(root, text="Delete Product", command=delete_product, width=20, height=2, bg="#87CEEB", fg="black")
delete_btn.pack(pady=5)
purchase_btn = tk.Button(root, text="Purchase Product", command=purchase_product, width=20, height=2, bg="#87CEEB", fg="black")
purchase_btn.pack(pady=5)
view_purchases_btn = tk.Button(root, text="View Purchases", command=view_purchases, width=20, height=2, bg="#87CEEB", fg="black")
view_purchases_btn.pack(pady=5)
view_stock_btn = tk.Button(root, text="View Stock", command=view_stock, width=20, height=2, bg="#87CEEB", fg="black")
view_stock_btn.pack(pady=5)
sell_item_btn = tk.Button(root, text="Sell Item", command=sell_item, width=20, height=2, bg="#87CEEB", fg="black")
sell_item_btn.pack(pady=5)
view_sales_btn = tk.Button(root, text="View Sales Details", command=view_sales_details_gui, width=20, height=2, bg="#87CEEB", fg="black")
